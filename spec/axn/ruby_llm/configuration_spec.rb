...
RSpec.describe "Axn::RubyLLM configuration" do
  ...
  describe "backward-compatible aliases" do
    it "exposes .configuration as an alias for .config" do
      expect(Axn::RubyLLM.configuration).to equal(Axn::RubyLLM.config)
    end
    ...
    it "exposes reset_configuration! as an alias for reset_config!" do
      Axn::RubyLLM.configure { |c| c.default_model = "o3-mini" }
